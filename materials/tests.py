...
class SectionViewSetTest(APITestCase):
    ...
    def setUp(self):
        ...
        self.section_detail_url = reverse('materials:section-detail', kwargs={'pk': self.section.id})
    ...
    def test_create_section_as_teacher(self):
        ...
        self.assertEqual(Section.objects.get(name='New Section').owner, self.teacher_user)
...
class MaterialViewSetTest(APITestCase):
    ...
    def setUp(self):
        ...
        self.material_detail_url = reverse('materials:material-detail', kwargs={'pk': self.material.id})
    ...
    def test_create_material_as_teacher(self):
        ...
        self.assertEqual(Material.objects.get(name='New Material').owner, self.teacher_user)
