...
from materials.views import SectionCreateAPIView, SectionListAPIView, SectionRetrieveAPIView, SectionUpdateAPIView, \
    SectionDestroyAPIView, MaterialCreateAPIView, MaterialListAPIView, MaterialRetrieveAPIView, MaterialUpdateAPIView, \
...
urlpatterns = [
    ...
    path('material/destroy/', MaterialDestroyAPIView.as_view(), name='material_destroy')
]
